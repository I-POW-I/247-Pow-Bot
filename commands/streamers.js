  ...
  async execute(interaction) {
    ...
    if (subs.length === 0) {
      return interaction.reply({
        content: '📭 No streamers are currently being watched in this server. Use `/addstreamer` to add one.',
    ...
    const embed = new EmbedBuilder()
      ...
      .setDescription('Live streamer subscriptions currently active in this server.')
      .setColor(0x7b8cff)
      .setFooter({ text: `24/7 POW Bot • ${subs.length} streamer(s) total` })
      .setTimestamp();
