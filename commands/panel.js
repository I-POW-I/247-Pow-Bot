...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('panel')
    .setDescription('Post the live 24/7 POW Bot control panel in this channel')
  ...
  async execute(interaction, client) {
    ...
    if (!channel.permissionsFor(botMember).has(['SendMessages', 'EmbedLinks'])) {
      return interaction.reply({
        content: '❌ 24/7 POW Bot needs **Send Messages** and **Embed Links** permission in this channel.',
    ...
    return interaction.reply({
      content: '✅ The control panel is now live and ready for use.',
      flags: [MessageFlags.Ephemeral],
    });
  },
};
